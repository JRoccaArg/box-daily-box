...
const ja: Translations = {
  ...
  "profile.delete_warning": "プレイ履歴、実績、バッジ、フレンド、デュエルがすべて完全に削除されます。この操作は取り消せません。",
  "profile.delete_confirm": "はい、すべて削除する",
  ...
  "badge.ach_legend_10": "生ける伝説",
  "badge.ach_legend_50": "レジェンドマスター",
  "badge.ach_wins_100": "センチュリオン",
  "badge.ach_wins_500": "500周",
  "badge.ach_specialist_50": "スペシャリスト",
  "badge.ach_perfect_day": "パーフェクト・グランプリ",
  "badge.ach_complete": "完全なドライバー",
  "badge.tooltip_ach_legend_10": "レジェンド難易度で10勝。",
  "badge.tooltip_ach_legend_50": "レジェンド難易度で50勝。",
  "badge.tooltip_ach_wins_100": "通算100勝。",
  "badge.tooltip_ach_wins_500": "通算500勝 — エリートレベル。",
  "badge.tooltip_ach_specialist_50": "同じゲームで50回勝利。",
  "badge.tooltip_ach_perfect_day": "1日で8ゲームすべてに勝利。",
  "badge.tooltip_ach_complete": "利用可能な8ゲームすべてで少なくとも1回勝利。",
  "stats.tab_achievements": "実績",
  "achievement.loading": "実績を読み込み中...",
  "achievement.load_error": "実績を読み込めませんでした。",
  "achievement.title": "マイ実績",
  "achievement.unlocked_count": "{{total}}個中{{count}}個を解除",
  "achievement.featured_title": "ランキングバッジ",
  "achievement.automatic_badge": "自動",
  "achievement.automatic_hint": "表彰台バッジを優先し、その後に難しい実績を表示します。",
  "achievement.manual_hint": "解除済みの実績をタップして追加または削除できます。選択中のメダルも削除できます。",
  "achievement.remove_featured": "ランキングから{{name}}を削除",
  "achievement.none_selected": "名前の横にバッジは表示されません。",
  "achievement.max_reached": "利用可能な3枠はすべて埋まっています。",
  "achievement.use_automatic": "自動選択を使用",
  "achievement.unlocked": "解除済み",
  "achievement.in_progress": "進行中",
  "achievement.unlocked_toast": "実績を解除しました：{{name}}！",
  "badge.admin": "管理者",
