...
const ru: Translations = {
  ...
  // ─── Modo Carrera ───────────────────────────────────────────────
  "career.abandon.confirm_body": "Это удалит прогресс в этой партии. Отменить нельзя.",
  "career.abandon.confirm_no": "Отмена",
  "career.abandon.confirm_title": "Прервать эту карьеру?",
  "career.abandon.confirm_yes": "Да, прервать",
  "career.abandon.link": "Прервать карьеру",
  "career.event.continue": "Продолжить",
  "career.event.progress": "Событие {{current}} из {{total}}",
  "career.history.empty": "Вы ещё не провели ни одного сезона",
  "career.history.eyebrow": "Режим карьеры",
  "career.history.points_teammate": "Напарник: {{points}} очк.",
  "career.history.points_you": "Вы: {{points}} очк.",
  "career.history.title": "Ваша карьера",
  "career.history.wins_podiums": "{{wins}} побед, {{podiums}} подиумов",
  "career.no_seat.body": "В этом сезоне у вас нет команды. Симулируйте год, чтобы узнать, придут ли предложения.",
  "career.no_seat.eyebrow": "Без места",
  "career.no_seat.simulate": "Симулировать год",
  "career.no_seat.title": "В поисках места",
  "career.offers.accept": "Принять",
  "career.offers.car_rank": "Машина №{{rank}} года",
  "career.offers.decline_all": "Отклонить все",
  "career.offers.decline_confirm_body": "В этом году вы останетесь без команды. Новые предложения могут прийти в следующем году.",
  "career.offers.decline_confirm_no": "Отмена",
  "career.offers.decline_confirm_title": "Отклонить все предложения?",
  "career.offers.decline_confirm_yes": "Да, отклонить",
  "career.offers.eyebrow": "Рынок пилотов",
  "career.offers.intro": "Ваш контракт закончился. Эти команды хотят вас подписать:",
  "career.offers.role_first": "Первый пилот",
  "career.offers.role_second": "Второй пилот",
  "career.offers.rookie_intro": "Вы новичок в Формуле 1. Эти команды предлагают вам место:",
  "career.offers.rookie_title": "Ваши первые предложения",
  "career.offers.title": "Предложения команд",
  "career.offers.years": "Контракт на {{years}} год(а/лет)",
  "career.ready.contract_years": "Контракт: осталось {{years}} год(а/лет)",
  "career.ready.eyebrow": "Режим карьеры",
  "career.ready.retire_button": "Завершить карьеру",
  "career.ready.retire_confirm_body": "Ваша карьера закончится здесь. Отменить нельзя.",
  "career.ready.retire_confirm_no": "Продолжить гонки",
  "career.ready.retire_confirm_title": "Завершить карьеру?",
  "career.ready.retire_confirm_yes": "Да, завершить",
  "career.ready.season_of_max": "Сезон {{season}} из {{max}}",
  "career.ready.simulate_button": "Симулировать {{step}} сезон(а/ов)",
  "career.retired.epilogue_champion": "Ваше имя вошло в учебники истории: чемпион мира.",
  "career.retired.epilogue_scorer": "Вы никогда не выигрывали гонку, но набирали очки и оставили свой след.",
  "career.retired.epilogue_struggler": "Не та машина и не та удача, о которых вы мечтали, но вы выступали в высшей категории автоспорта.",
  "career.retired.epilogue_winner": "Вы выигрывали гонки и заслужили уважение паддока, хотя титул ускользнул.",
  "career.retired.eyebrow": "Карьера окончена",
  "career.retired.new_career": "Новая карьера",
  "career.retired.reason_max_seasons": "Вы завершили все 24 сезона",
  "career.retired.reason_no_offers": "Ни одна команда не предложила вам место",
  "career.retired.reason_voluntary": "Вы решили повесить шлем на гвоздь",
  "career.retired.summary_championships": "Титулы",
  "career.retired.summary_dnfs": "Сходы",
  "career.retired.summary_podiums": "Подиумы",
  "career.retired.summary_poles": "Поулы",
  "career.retired.summary_seasons": "Сезоны",
  "career.retired.summary_teammate_record": "Вы обыграли напарника {{won}} раз, проиграли {{lost}}",
  "career.retired.summary_wins": "Победы",
  "career.season.accidents": "Аварии",
  "career.season.constructors_champion": "Ваша команда — чемпион в зачёте конструкторов!",
  "career.season.continue": "Продолжить",
  "career.season.drivers_champion": "Чемпион среди пилотов!",
  "career.season.eyebrow": "Итоги сезона",
  "career.season.fastest_laps": "Быстрые круги",
  "career.season.mechanical_dnfs": "Сходы по техническим причинам",
  "career.season.no_seat": "Вы не выступали в этом сезоне",
  "career.season.overtakes": "Обгоны",
  "career.season.performance_above": "Вы показали результат выше возможностей машины",
  "career.season.performance_below": "Вы показали результат ниже возможностей машины",
  "career.season.performance_even": "Ваш результат соответствовал уровню машины",
  "career.season.podiums": "Подиумы",
  "career.season.points": "Очки",
  "career.season.poles": "Поулы",
  "career.season.position": "Позиция",
  "career.season.teammate_comparison": "Вы: {{points}} очк. — {{teammate}}: {{teammatePoints}} очк.",
  "career.season.title": "Сезон {{year}}",
  "career.season.wins": "Победы",
  "career.setup.eyebrow": "Режим карьеры",
  "career.setup.first_name": "Имя",
  "career.setup.intro": "Создайте пилота и проживите его карьеру: до 24 сезонов решений, удачи и результатов. Не влияет на ваш рейтинг и статистику ежедневного испытания.",
  "career.setup.last_name": "Фамилия",
  "career.setup.mode_1": "По 1 году за раз",
  "career.setup.mode_1_hint": "Больше контроля, партии длиннее",
  "career.setup.mode_2": "По 2 года за раз",
  "career.setup.mode_2_hint": "Баланс между контролем и темпом",
  "career.setup.mode_3": "По 3 года за раз",
  "career.setup.mode_3_hint": "Партии быстрее",
  "career.setup.mode_hint": "На сколько лет вы продвигаетесь за раз",
  "career.setup.mode_label": "Режим игры",
  "career.setup.name_required": "Введите имя и фамилию",
  "career.setup.nationality": "Национальность",
  "career.setup.nationality_placeholder": "Выберите вашу национальность",
