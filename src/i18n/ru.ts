...
const ru: Translations = {
  ...
  "consent.title": "Конфиденциальность и cookie",
  "consent.message": "Мы используем аналитику, чтобы понять, как играют, и улучшать сайт. Вы можете принять или отклонить.",
  "consent.accept": "Принять",
  "consent.reject": "Отклонить",
  "consent.manage": "Управление cookie",
  ...
  "profile.delete_warning": "История матчей, достижения, значки, друзья и дуэли будут удалены навсегда. Это действие необратимо.",
  "profile.delete_confirm": "Да, удалить всё",
  "profile.deleting": "Удаление...",
  "profile.delete_error": "Не удалось удалить аккаунт. Попробуйте ещё раз.",
  ...
  "badge.ach_legend_10": "Живая легенда",
  "badge.ach_legend_50": "Мастер Легенды",
  "badge.ach_wins_100": "Центурион",
  "badge.ach_wins_500": "500 кругов",
  "badge.ach_specialist_50": "Специалист",
  "badge.ach_perfect_day": "Идеальный Гран-при",
  "badge.ach_complete": "Полный пилот",
  "badge.tooltip_ach_legend_10": "10 побед на сложности «Легенда».",
  "badge.tooltip_ach_legend_50": "50 побед на сложности «Легенда».",
  "badge.tooltip_ach_wins_100": "100 побед всего.",
  "badge.tooltip_ach_wins_500": "500 побед всего — элитный уровень.",
  "badge.tooltip_ach_specialist_50": "Выиграли одну и ту же игру 50 раз.",
  "badge.tooltip_ach_perfect_day": "Выиграли все 8 игр за один день.",
  "badge.tooltip_ach_complete": "Выиграли каждую из 8 доступных игр хотя бы раз.",
  "stats.tab_achievements": "Достижения",
  "achievement.loading": "Загрузка достижений...",
  "achievement.load_error": "Не удалось загрузить достижения.",
  "achievement.title": "Мои достижения",
  "achievement.unlocked_count": "Открыто {{count}} из {{total}}",
  "achievement.featured_title": "Значки в рейтинге",
  "achievement.automatic_badge": "Автоматически",
  "achievement.automatic_hint": "Система сначала показывает награды за подиум, затем самые сложные достижения.",
  "achievement.manual_hint": "Нажмите на открытое достижение, чтобы добавить или убрать его. Выбранные медали тоже можно убрать.",
  "achievement.remove_featured": "Убрать {{name}} из рейтинга",
  "achievement.none_selected": "Рядом с вашим именем не будет значков.",
  "achievement.max_reached": "Все 3 доступных места уже заняты.",
  "achievement.use_automatic": "Использовать автоматический выбор",
  "achievement.unlocked": "Открыто",
  "achievement.in_progress": "В процессе",
  "achievement.unlocked_toast": "Достижение получено: {{name}}!",
  "badge.admin": "Админ",
