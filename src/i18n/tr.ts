...
const tr: Translations = {
  ...
  // ─── Modo Carrera ───────────────────────────────────────────────
  "career.abandon.confirm_body": "Bu, bu oyundaki ilerlemenizi silecek. Geri alınamaz.",
  "career.abandon.confirm_no": "İptal",
  "career.abandon.confirm_title": "Bu kariyer terk edilsin mi?",
  "career.abandon.confirm_yes": "Evet, terk et",
  "career.abandon.link": "Kariyeri terk et",
  "career.event.continue": "Devam et",
  "career.event.progress": "Olay {{current}} / {{total}}",
  "career.history.empty": "Henüz bir sezon yarışmadınız",
  "career.history.eyebrow": "Kariyer Modu",
  "career.history.points_teammate": "Takım arkadaşı: {{points}} puan",
  "career.history.points_you": "Siz: {{points}} puan",
  "career.history.title": "Kariyeriniz",
  "career.history.wins_podiums": "{{wins}} galibiyet, {{podiums}} podyum",
  "career.no_seat.body": "Bu sezon takımınız yok. Teklif gelip gelmediğini görmek için yılı simüle edin.",
  "career.no_seat.eyebrow": "Koltuk yok",
  "career.no_seat.simulate": "Yılı simüle et",
  "career.no_seat.title": "Koltuk aranıyor",
  "career.offers.accept": "Kabul et",
  "career.offers.car_rank": "Yılın {{rank}}. sıradaki arabası",
  "career.offers.decline_all": "Tümünü reddet",
  "career.offers.decline_confirm_body": "Bu yıl takımsız kalacaksınız. Gelecek yıl yeni teklifler gelebilir.",
  "career.offers.decline_confirm_no": "İptal",
  "career.offers.decline_confirm_title": "Tüm teklifler reddedilsin mi?",
  "career.offers.decline_confirm_yes": "Evet, reddet",
  "career.offers.eyebrow": "Pilot pazarı",
  "career.offers.intro": "Sözleşmeniz sona erdi. Bu takımlar sizi kadroya katmak istiyor:",
  "career.offers.role_first": "Birinci pilot",
  "career.offers.role_second": "İkinci pilot",
  "career.offers.rookie_intro": "Formula 1'de yenisiniz. Bu takımlar size koltuk teklif ediyor:",
  "career.offers.rookie_title": "İlk teklifleriniz",
  "career.offers.title": "Takım teklifleri",
  "career.offers.years": "{{years}} yıllık sözleşme",
  "career.ready.contract_years": "Sözleşme: {{years}} yıl kaldı",
  "career.ready.eyebrow": "Kariyer Modu",
  "career.ready.retire_button": "Emekli ol",
  "career.ready.retire_confirm_body": "Kariyeriniz burada sona erecek. Geri alınamaz.",
  "career.ready.retire_confirm_no": "Yarışmaya devam et",
  "career.ready.retire_confirm_title": "Emekli olunsun mu?",
  "career.ready.retire_confirm_yes": "Evet, emekli oluyorum",
  "career.ready.season_of_max": "{{max}} sezonun {{season}}.",
  "career.ready.simulate_button": "{{step}} sezon simüle et",
  "career.retired.epilogue_champion": "Adınız tarih kitaplarına geçti: dünya şampiyonu.",
  "career.retired.epilogue_scorer": "Hiç yarış kazanmadınız ama puan topladınız ve izinizi bıraktınız.",
  "career.retired.epilogue_struggler": "Hayalini kurduğunuz araba ya da şans değildi, ama motorsporun en üst kategorisinde yarıştınız.",
  "career.retired.epilogue_winner": "Yarışlar kazandınız ve unvan elinizden kaçsa da paddock'un saygısını kazandınız.",
  "career.retired.eyebrow": "Kariyer sona erdi",
  "career.retired.new_career": "Yeni kariyer",
  "career.retired.reason_max_seasons": "24 sezonun tamamını tamamladınız",
  "career.retired.reason_no_offers": "Hiçbir takım size koltuk teklif etmedi",
  "career.retired.reason_voluntary": "Kaskı asmaya karar verdiniz",
  "career.retired.summary_championships": "Şampiyonluklar",
  "career.retired.summary_dnfs": "Yarış bırakmalar",
  "career.retired.summary_podiums": "Podyumlar",
  "career.retired.summary_poles": "Pole pozisyonları",
  "career.retired.summary_seasons": "Sezonlar",
  "career.retired.summary_teammate_record": "Takım arkadaşınızı {{won}} kez yendiniz, {{lost}} kez kaybettiniz",
  "career.retired.summary_wins": "Galibiyetler",
  "career.season.accidents": "Kazalar",
  "career.season.constructors_champion": "Takımınız yapıcılar şampiyonu!",
  "career.season.continue": "Devam et",
  "career.season.drivers_champion": "Pilotlar şampiyonu!",
  "career.season.eyebrow": "Sezon özeti",
  "career.season.fastest_laps": "En hızlı turlar",
  "career.season.mechanical_dnfs": "Mekanik arıza sonucu çekilmeler",
  "career.season.no_seat": "Bu sezon yarışmadınız",
  "career.season.overtakes": "Geçişler",
  "career.season.performance_above": "Arabanızın potansiyelinin üzerinde performans gösterdiniz",
  "career.season.performance_below": "Arabanızın potansiyelinin altında performans gösterdiniz",
  "career.season.performance_even": "Arabanızın seviyesine uygun performans gösterdiniz",
  "career.season.podiums": "Podyumlar",
  "career.season.points": "Puan",
  "career.season.poles": "Pole pozisyonları",
  "career.season.position": "Sıralama",
  "career.season.teammate_comparison": "Siz: {{points}} puan — {{teammate}}: {{teammatePoints}} puan",
  "career.season.title": "{{year}} Sezonu",
  "career.season.wins": "Galibiyetler",
  "career.setup.eyebrow": "Kariyer Modu",
  "career.setup.first_name": "Ad",
  "career.setup.intro": "Bir pilot yaratın ve kariyerini yaşayın: 24 sezona kadar kararlar, şans ve sonuçlar. Sıralamanızı veya günlük mücadele istatistiklerinizi etkilemez.",
  "career.setup.last_name": "Soyad",
  "career.setup.mode_1": "Seferde 1 yıl",
  "career.setup.mode_1_hint": "Daha fazla kontrol, daha uzun oyun",
  "career.setup.mode_2": "Seferde 2 yıl",
  "career.setup.mode_2_hint": "Kontrol ve hız arasında denge",
  "career.setup.mode_3": "Seferde 3 yıl",
  "career.setup.mode_3_hint": "Daha hızlı oyun",
  "career.setup.mode_hint": "Her seferinde kaç yıl ilerlediğiniz",
  "career.setup.mode_label": "Oyun modu",
  "career.setup.name_required": "Ad ve soyad girin",
  "career.setup.nationality": "Uyruk",
  "career.setup.nationality_placeholder": "Uyruğunuzu seçin",
