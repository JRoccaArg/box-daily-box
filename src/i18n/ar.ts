...
const ar: Translations = {
  ...
  // ─── Modo Carrera ───────────────────────────────────────────────
  "career.abandon.confirm_body": "سيؤدي هذا إلى حذف تقدمك في هذه الجولة. لا يمكن التراجع عن ذلك.",
  "career.abandon.confirm_no": "إلغاء",
  "career.abandon.confirm_title": "هل تريد ترك هذه المسيرة؟",
  "career.abandon.confirm_yes": "نعم، اترك",
  "career.abandon.link": "ترك المسيرة",
  "career.event.continue": "متابعة",
  "career.event.progress": "الحدث {{current}} من {{total}}",
  "career.history.empty": "لم تخض أي موسم بعد",
  "career.history.eyebrow": "وضع المسيرة",
  "career.history.points_teammate": "زميلك: {{points}} نقطة",
  "career.history.points_you": "أنت: {{points}} نقطة",
  "career.history.title": "مسيرتك",
  "career.history.wins_podiums": "{{wins}} فوز، {{podiums}} منصة",
  "career.no_seat.body": "ليس لديك فريق هذا الموسم. حاكِ العام لترى إن كانت هناك عروض قادمة.",
  "career.no_seat.eyebrow": "بلا مقعد",
  "career.no_seat.simulate": "محاكاة العام",
  "career.no_seat.title": "البحث عن فريق",
  "career.offers.accept": "قبول",
  "career.offers.car_rank": "السيارة رقم {{rank}} هذا العام",
  "career.offers.decline_all": "رفض الجميع",
  "career.offers.decline_confirm_body": "ستبقى بلا فريق هذا العام. قد تصل عروض جديدة العام المقبل.",
  "career.offers.decline_confirm_no": "إلغاء",
  "career.offers.decline_confirm_title": "رفض جميع العروض؟",
  "career.offers.decline_confirm_yes": "نعم، ارفض",
  "career.offers.eyebrow": "سوق السائقين",
  "career.offers.intro": "انتهى عقدك. هذه الفرق تريد التعاقد معك:",
  "career.offers.role_first": "السائق الأول",
  "career.offers.role_second": "السائق الثاني",
  "career.offers.rookie_intro": "أنت جديد في الفورمولا 1. هذه الفرق تعرض عليك مقعدًا:",
  "career.offers.rookie_title": "عروضك الأولى",
  "career.offers.title": "عروض الفرق",
  "career.offers.years": "عقد لمدة {{years}} سنة",
  "career.ready.contract_years": "العقد: تبقى {{years}} سنة",
  "career.ready.eyebrow": "وضع المسيرة",
  "career.ready.retire_button": "الاعتزال",
  "career.ready.retire_confirm_body": "ستنتهي مسيرتك هنا. لا يمكن التراجع عن ذلك.",
  "career.ready.retire_confirm_no": "مواصلة السباق",
  "career.ready.retire_confirm_title": "هل تريد الاعتزال؟",
  "career.ready.retire_confirm_yes": "نعم، اعتزل",
  "career.ready.season_of_max": "الموسم {{season}} من {{max}}",
  "career.ready.simulate_button": "محاكاة {{step}} موسم",
  "career.retired.epilogue_champion": "اسمك بات في كتب التاريخ: بطل العالم.",
  "career.retired.epilogue_scorer": "لم تفز بسباق قط، لكنك سجّلت نقاطًا وتركت بصمتك.",
  "career.retired.epilogue_struggler": "لم تكن السيارة أو الحظ اللذين حلمت بهما، لكنك تسابقت في أعلى فئة في رياضة السيارات.",
  "career.retired.epilogue_winner": "فزت بسباقات وكسبت احترام الحظيرة، حتى وإن أفلت منك اللقب.",
  "career.retired.eyebrow": "نهاية المسيرة",
  "career.retired.new_career": "مسيرة جديدة",
  "career.retired.reason_max_seasons": "أكملت جميع المواسم الـ24",
  "career.retired.reason_no_offers": "لم يعرض عليك أي فريق مقعدًا",
  "career.retired.reason_voluntary": "قررت تعليق خوذتك",
  "career.retired.summary_championships": "البطولات",
  "career.retired.summary_dnfs": "الانسحابات",
  "career.retired.summary_podiums": "المنصات",
  "career.retired.summary_poles": "مراكز الانطلاق الأولى",
  "career.retired.summary_seasons": "المواسم",
  "career.retired.summary_teammate_record": "هزمت زميلك {{won}} مرة، وخسرت {{lost}} مرة",
  "career.retired.summary_wins": "الانتصارات",
  "career.season.accidents": "الحوادث",
  "career.season.constructors_champion": "فريقك بطل كأس الصانعين!",
  "career.season.continue": "متابعة",
  "career.season.drivers_champion": "بطل السائقين!",
  "career.season.eyebrow": "ملخص الموسم",
  "career.season.fastest_laps": "أسرع اللفات",
  "career.season.mechanical_dnfs": "انسحابات ميكانيكية",
  "career.season.no_seat": "لم تتسابق هذا الموسم",
  "career.season.overtakes": "التجاوزات",
  "career.season.performance_above": "أديت أداءً أفضل من إمكانات سيارتك",
  "career.season.performance_below": "أديت أداءً أقل من إمكانات سيارتك",
  "career.season.performance_even": "كان أداؤك متوافقًا مع مستوى سيارتك",
  "career.season.podiums": "المنصات",
  "career.season.points": "النقاط",
  "career.season.poles": "مراكز الانطلاق الأولى",
  "career.season.position": "الترتيب",
  "career.season.teammate_comparison": "أنت: {{points}} نقطة — {{teammate}}: {{teammatePoints}} نقطة",
  "career.season.title": "موسم {{year}}",
  "career.season.wins": "الانتصارات",
  "career.setup.eyebrow": "وضع المسيرة",
  "career.setup.first_name": "الاسم الأول",
  "career.setup.intro": "أنشئ سائقًا وعِش مسيرته: حتى 24 موسمًا من القرارات والحظ والنتائج. لا يؤثر على ترتيبك أو إحصائيات التحدي اليومي.",
  "career.setup.last_name": "اسم العائلة",
  "career.setup.mode_1": "سنة واحدة في كل مرة",
  "career.setup.mode_1_hint": "تحكم أكبر، مباريات أطول",
  "career.setup.mode_2": "سنتان في كل مرة",
  "career.setup.mode_2_hint": "توازن بين التحكم والإيقاع",
  "career.setup.mode_3": "3 سنوات في كل مرة",
  "career.setup.mode_3_hint": "مباريات أسرع",
  "career.setup.mode_hint": "كم سنة تتقدم في كل مرة",
  "career.setup.mode_label": "وضع اللعبة",
  "career.setup.name_required": "أدخل الاسم الأول واسم العائلة",
  "career.setup.nationality": "الجنسية",
  "career.setup.nationality_placeholder": "اختر جنسيتك",
