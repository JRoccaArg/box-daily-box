...
const es: Translations = {
  ...
  "consent.title": "Privacidad y cookies",
  "consent.message": "Usamos analíticas para entender cómo se juega y mejorar el sitio. Puedes aceptarlas o rechazarlas.",
  ...
  "profile.delete_account": "Borrar mi cuenta",
  "profile.delete_warning": "Se borrarán para siempre tu historial de partidas, tus logros, tus badges, tus amigos y tus duelos. Esta acción no se puede deshacer.",
  "profile.delete_confirm": "Sí, borrar todo",
  "profile.deleting": "Borrando...",
  "profile.delete_error": "No se pudo borrar la cuenta. Inténtalo de nuevo.",
  ...
  "badge.ach_legend_10": "Leyenda Viviente",
  "badge.ach_legend_50": "Maestro de Leyenda",
  "badge.ach_wins_100": "Centurión",
  "badge.ach_wins_500": "500 Vueltas",
  "badge.ach_specialist_50": "Especialista",
  "badge.ach_perfect_day": "Gran Premio Perfecto",
  "badge.ach_complete": "Piloto Completo",
  "badge.tooltip_ach_legend_10": "10 victorias en dificultad Leyenda.",
  "badge.tooltip_ach_legend_50": "50 victorias en dificultad Leyenda.",
  "badge.tooltip_ach_wins_100": "100 victorias acumuladas.",
  "badge.tooltip_ach_wins_500": "500 victorias acumuladas — nivel élite.",
  "badge.tooltip_ach_specialist_50": "Ganaste el mismo juego 50 veces.",
  "badge.tooltip_ach_perfect_day": "Ganaste los 8 juegos en un solo día.",
  "badge.tooltip_ach_complete": "Ganaste los 8 juegos disponibles al menos una vez.",
  "stats.tab_achievements": "Logros",
  "achievement.loading": "Cargando logros...",
  "achievement.load_error": "No se pudieron cargar los logros.",
  "achievement.title": "Mis logros",
  "achievement.unlocked_count": "{{count}} de {{total}} desbloqueados",
  "achievement.featured_title": "Badges del ranking",
  "achievement.automatic_badge": "Automático",
  "achievement.automatic_hint": "El sistema muestra primero el podio y luego tus logros más difíciles.",
  "achievement.manual_hint": "Toca un logro desbloqueado para añadirlo o quitarlo. También puedes quitar las medallas seleccionadas.",
  "achievement.remove_featured": "Quitar {{name}} del ranking",
  "achievement.none_selected": "No se mostrará ningún badge junto a tu nombre.",
  "achievement.max_reached": "Ya ocupaste los 3 lugares disponibles.",
  "achievement.use_automatic": "Usar selección automática",
  "achievement.unlocked": "Desbloqueado",
  "achievement.in_progress": "En progreso",
  "achievement.unlocked_toast": "¡Logro desbloqueado: {{name}}!",
  "badge.admin": "Admin",
  ...
  "gpEvent.soon_sub": "Sábado y domingo, todos los retos valen el doble.",
  "gpEvent.ends_in": "Termina en",
  "gpEvent.starts_in": "Empieza en",
  "gpEvent.aria_active": "Fin de semana del Gran Premio de {{circuit}}: hoy los retos dan {{multiplier}} veces los puntos.",
  "gpEvent.aria_soon": "Fin de semana del Gran Premio de {{circuit}}: el sábado y el domingo los retos darán {{multiplier}} veces los puntos.",
};
