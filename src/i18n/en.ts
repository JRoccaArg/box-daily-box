...
const en: Translations = {
  ...
  // ─── Modo Carrera ───────────────────────────────────────────────
  "career.abandon.confirm_body": "This will delete your progress in this run. It can't be undone.",
  "career.abandon.confirm_no": "Cancel",
  "career.abandon.confirm_title": "Abandon this career?",
  "career.abandon.confirm_yes": "Yes, abandon",
  "career.abandon.link": "Abandon career",
  "career.event.continue": "Continue",
  "career.event.progress": "Event {{current}} of {{total}}",
  "career.history.empty": "You haven't raced a season yet",
  "career.history.eyebrow": "Career Mode",
  "career.history.points_teammate": "Team mate: {{points}} pts",
  "career.history.points_you": "You: {{points}} pts",
  "career.history.title": "Your career",
  "career.history.wins_podiums": "{{wins}} wins, {{podiums}} podiums",
  "career.no_seat.body": "You have no team this season. Simulate the year to see if any offers come in.",
  "career.no_seat.eyebrow": "No seat",
  "career.no_seat.simulate": "Simulate year",
  "career.no_seat.title": "Looking for a seat",
  "career.offers.accept": "Accept",
  "career.offers.car_rank": "Car ranked #{{rank}} this year",
  "career.offers.decline_all": "Decline all",
  "career.offers.decline_confirm_body": "You'll be without a team this year. New offers may come in next year.",
  "career.offers.decline_confirm_no": "Cancel",
  "career.offers.decline_confirm_title": "Decline all offers?",
  "career.offers.decline_confirm_yes": "Yes, decline",
  "career.offers.eyebrow": "Driver market",
  "career.offers.intro": "Your contract has ended. These teams want to sign you:",
  "career.offers.role_first": "Number one driver",
  "career.offers.role_second": "Number two driver",
  "career.offers.rookie_intro": "You're new to Formula 1. These teams are offering you a seat:",
  "career.offers.rookie_title": "Your first offers",
  "career.offers.title": "Team offers",
  "career.offers.years": "{{years}}-year contract",
  "career.ready.contract_years": "Contract: {{years}} year(s) left",
  "career.ready.eyebrow": "Career Mode",
  "career.ready.retire_button": "Retire",
  "career.ready.retire_confirm_body": "Your career will end here. This can't be undone.",
  "career.ready.retire_confirm_no": "Keep racing",
  "career.ready.retire_confirm_title": "Retire?",
  "career.ready.retire_confirm_yes": "Yes, retire",
  "career.ready.season_of_max": "Season {{season}} of {{max}}",
  "career.ready.simulate_button": "Simulate {{step}} season(s)",
  "career.retired.epilogue_champion": "Your name goes into the history books: world champion.",
  "career.retired.epilogue_scorer": "You never won a race, but you scored points and left your mark.",
  "career.retired.epilogue_struggler": "Not the car or the luck you dreamed of, but you raced at the top level of motorsport.",
  "career.retired.epilogue_winner": "You won races and earned the paddock's respect, even if the title slipped away.",
  "career.retired.eyebrow": "Career over",
  "career.retired.new_career": "New career",
  "career.retired.reason_max_seasons": "You completed all 24 seasons",
  "career.retired.reason_no_offers": "No team offered you a seat",
  "career.retired.reason_voluntary": "You decided to hang up your helmet",
  "career.retired.summary_championships": "Championships",
  "career.retired.summary_dnfs": "Retirements",
  "career.retired.summary_podiums": "Podiums",
  "career.retired.summary_poles": "Poles",
  "career.retired.summary_seasons": "Seasons",
  "career.retired.summary_teammate_record": "You beat your team mate {{won}} times, lost {{lost}}",
  "career.retired.summary_wins": "Wins",
  "career.season.accidents": "Accidents",
  "career.season.constructors_champion": "Your team won the constructors' championship!",
  "career.season.continue": "Continue",
  "career.season.drivers_champion": "Drivers' champion!",
  "career.season.eyebrow": "Season summary",
  "career.season.fastest_laps": "Fastest laps",
  "career.season.mechanical_dnfs": "Mechanical retirements",
  "career.season.no_seat": "You didn't race this season",
  "career.season.overtakes": "Overtakes",
  "career.season.performance_above": "You outperformed what your car could do",
  "career.season.performance_below": "You underperformed what your car could do",
  "career.season.performance_even": "You performed in line with your car",
  "career.season.podiums": "Podiums",
  "career.season.points": "Points",
  "career.season.poles": "Poles",
  "career.season.position": "Position",
  "career.season.teammate_comparison": "You: {{points}} pts — {{teammate}}: {{teammatePoints}} pts",
  "career.season.title": "Season {{year}}",
  "career.season.wins": "Wins",
  "career.setup.eyebrow": "Career Mode",
  "career.setup.first_name": "First name",
  "career.setup.intro": "Create a driver and live their career: up to 24 seasons of decisions, luck and results. It doesn't affect your ranking or your daily challenge stats.",
  "career.setup.last_name": "Last name",
  "career.setup.mode_1": "1 year at a time",
  "career.setup.mode_1_hint": "More control, longer to play",
  "career.setup.mode_2": "2 years at a time",
  "career.setup.mode_2_hint": "A balance between control and pace",
  "career.setup.mode_3": "3 years at a time",
  "career.setup.mode_3_hint": "Faster to play",
  "career.setup.mode_hint": "How many years you advance at a time",
  "career.setup.mode_label": "Game mode",
  "career.setup.name_required": "Enter a first and last name",
  "career.setup.nationality": "Nationality",
  "career.setup.nationality_placeholder": "Choose your nationality",
