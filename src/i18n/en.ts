...
const en: Translations = {
  ...
  "footer.photo_credit": "Driver photos: Wikimedia Commons (CC BY-SA / public domain).",
  "header.progress": "{{played}} of {{total}} games played today",
  ...
  "ranking.played_no_win": "Played, no wins",
  "ranking.pts": "pts",
