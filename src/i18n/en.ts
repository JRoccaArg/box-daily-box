...
const en: Translations = {
  ...
  "profile.delete_warning": "Your match history, achievements, badges, friends and duels will be permanently deleted. This cannot be undone.",
  "profile.delete_confirm": "Yes, delete everything",
  "profile.deleting": "Deleting...",
  "profile.delete_error": "Could not delete the account. Please try again.",
  ...
  "badge.ach_legend_10": "Living Legend",
  "badge.ach_legend_50": "Legend Master",
  "badge.ach_wins_100": "Centurion",
  "badge.ach_wins_500": "500 Laps",
  "badge.ach_specialist_50": "Specialist",
  "badge.ach_perfect_day": "Perfect Grand Prix",
  "badge.ach_complete": "Complete Driver",
  "badge.tooltip_ach_legend_10": "10 wins on Legend difficulty.",
  "badge.tooltip_ach_legend_50": "50 wins on Legend difficulty.",
  "badge.tooltip_ach_wins_100": "100 total wins.",
  "badge.tooltip_ach_wins_500": "500 total wins — elite level.",
  "badge.tooltip_ach_specialist_50": "Won the same game 50 times.",
  "badge.tooltip_ach_perfect_day": "Won all 8 games in a single day.",
  "badge.tooltip_ach_complete": "Won each of the 8 available games at least once.",
  "stats.tab_achievements": "Achievements",
  "achievement.loading": "Loading achievements...",
  "achievement.load_error": "Achievements could not be loaded.",
  "achievement.title": "My achievements",
  "achievement.unlocked_count": "{{count}} of {{total}} unlocked",
  "achievement.featured_title": "Ranking badges",
  "achievement.automatic_badge": "Automatic",
  "achievement.automatic_hint": "The system shows podium badges first, followed by your hardest achievements.",
  "achievement.manual_hint": "Tap an unlocked achievement to add or remove it. You can also remove selected podium badges.",
  "achievement.remove_featured": "Remove {{name}} from the ranking",
  "achievement.none_selected": "No badge will be shown next to your name.",
  "achievement.max_reached": "All 3 available slots are already filled.",
  "achievement.use_automatic": "Use automatic selection",
  "achievement.unlocked": "Unlocked",
  "achievement.in_progress": "In progress",
  "achievement.unlocked_toast": "Achievement unlocked: {{name}}!",
  "badge.admin": "Admin",
