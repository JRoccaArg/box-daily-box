...
const fr: Translations = {
  ...
  // ─── Modo Carrera ───────────────────────────────────────────────
  "career.abandon.confirm_body": "Cela supprimera votre progression dans cette partie. Action irréversible.",
  "career.abandon.confirm_no": "Annuler",
  "career.abandon.confirm_title": "Abandonner cette carrière ?",
  "career.abandon.confirm_yes": "Oui, abandonner",
  "career.abandon.link": "Abandonner la carrière",
  "career.event.continue": "Continuer",
  "career.event.progress": "Événement {{current}} sur {{total}}",
  "career.history.empty": "Vous n'avez encore couru aucune saison",
  "career.history.eyebrow": "Mode Carrière",
  "career.history.points_teammate": "Coéquipier : {{points}} pts",
  "career.history.points_you": "Vous : {{points}} pts",
  "career.history.title": "Votre carrière",
  "career.history.wins_podiums": "{{wins}} victoires, {{podiums}} podiums",
  "career.no_seat.body": "Vous n'avez pas d'écurie cette saison. Simulez l'année pour voir si des offres arrivent.",
  "career.no_seat.eyebrow": "Sans écurie",
  "career.no_seat.simulate": "Simuler l'année",
  "career.no_seat.title": "À la recherche d'une écurie",
  "career.offers.accept": "Accepter",
  "career.offers.car_rank": "Voiture classée n°{{rank}} de l'année",
  "career.offers.decline_all": "Refuser toutes",
  "career.offers.decline_confirm_body": "Vous resterez sans écurie cette année. De nouvelles offres pourraient arriver l'année prochaine.",
  "career.offers.decline_confirm_no": "Annuler",
  "career.offers.decline_confirm_title": "Refuser toutes les offres ?",
  "career.offers.decline_confirm_yes": "Oui, refuser",
  "career.offers.eyebrow": "Marché des pilotes",
  "career.offers.intro": "Votre contrat est terminé. Ces écuries veulent vous engager :",
  "career.offers.role_first": "Pilote numéro un",
  "career.offers.role_second": "Pilote numéro deux",
  "career.offers.rookie_intro": "Vous êtes nouveau en Formule 1. Ces écuries vous offrent un baquet :",
  "career.offers.rookie_title": "Vos premières offres",
  "career.offers.title": "Offres d'écuries",
  "career.offers.years": "Contrat de {{years}} an(s)",
  "career.ready.contract_years": "Contrat : {{years}} an(s) restant(s)",
  "career.ready.eyebrow": "Mode Carrière",
  "career.ready.retire_button": "Prendre ma retraite",
  "career.ready.retire_confirm_body": "Votre carrière s'arrêtera ici. Action irréversible.",
  "career.ready.retire_confirm_no": "Continuer à courir",
  "career.ready.retire_confirm_title": "Prendre votre retraite ?",
  "career.ready.retire_confirm_yes": "Oui, je me retire",
  "career.ready.season_of_max": "Saison {{season}} sur {{max}}",
  "career.ready.simulate_button": "Simuler {{step}} saison(s)",
  "career.retired.epilogue_champion": "Votre nom entre dans les livres d'histoire : champion du monde.",
  "career.retired.epilogue_scorer": "Vous n'avez jamais gagné de course, mais vous avez marqué des points et laissé votre empreinte.",
  "career.retired.epilogue_struggler": "Ni la voiture ni la chance dont vous rêviez, mais vous avez couru dans la catégorie reine du sport automobile.",
  "career.retired.epilogue_winner": "Vous avez gagné des courses et gagné le respect du paddock, même si le titre vous a échappé.",
  "career.retired.eyebrow": "Fin de carrière",
  "career.retired.new_career": "Nouvelle carrière",
  "career.retired.reason_max_seasons": "Vous avez terminé les 24 saisons",
  "career.retired.reason_no_offers": "Aucune écurie ne vous a offert de baquet",
  "career.retired.reason_voluntary": "Vous avez décidé de raccrocher le casque",
  "career.retired.summary_championships": "Championnats",
  "career.retired.summary_dnfs": "Abandons",
  "career.retired.summary_podiums": "Podiums",
  "career.retired.summary_poles": "Pole positions",
  "career.retired.summary_seasons": "Saisons",
  "career.retired.summary_teammate_record": "Vous avez battu votre coéquipier {{won}} fois, perdu {{lost}}",
  "career.retired.summary_wins": "Victoires",
  "career.season.accidents": "Accidents",
  "career.season.constructors_champion": "Votre écurie est championne des constructeurs !",
  "career.season.continue": "Continuer",
  "career.season.drivers_champion": "Champion des pilotes !",
  "career.season.eyebrow": "Résumé de la saison",
  "career.season.fastest_laps": "Meilleurs tours",
  "career.season.mechanical_dnfs": "Abandons mécaniques",
  "career.season.no_seat": "Vous n'avez pas couru cette saison",
  "career.season.overtakes": "Dépassements",
  "career.season.performance_above": "Vous avez dépassé le potentiel de votre voiture",
  "career.season.performance_below": "Vous étiez en dessous du potentiel de votre voiture",
  "career.season.performance_even": "Vous avez performé selon le niveau de votre voiture",
  "career.season.podiums": "Podiums",
  "career.season.points": "Points",
  "career.season.poles": "Pole positions",
  "career.season.position": "Position",
  "career.season.teammate_comparison": "Vous : {{points}} pts — {{teammate}} : {{teammatePoints}} pts",
  "career.season.title": "Saison {{year}}",
  "career.season.wins": "Victoires",
  "career.setup.eyebrow": "Mode Carrière",
  "career.setup.first_name": "Prénom",
  "career.setup.intro": "Créez un pilote et vivez sa carrière : jusqu'à 24 saisons de décisions, de chance et de résultats. Cela n'affecte pas votre classement ni vos statistiques du défi quotidien.",
  "career.setup.last_name": "Nom",
  "career.setup.mode_1": "1 an à la fois",
  "career.setup.mode_1_hint": "Plus de contrôle, parties plus longues",
  "career.setup.mode_2": "2 ans à la fois",
  "career.setup.mode_2_hint": "Un équilibre entre contrôle et rythme",
  "career.setup.mode_3": "3 ans à la fois",
  "career.setup.mode_3_hint": "Parties plus rapides",
  "career.setup.mode_hint": "Combien d'années vous avancez à chaque fois",
  "career.setup.mode_label": "Mode de jeu",
  "career.setup.name_required": "Entrez un prénom et un nom",
  "career.setup.nationality": "Nationalité",
  "career.setup.nationality_placeholder": "Choisissez votre nationalité",
