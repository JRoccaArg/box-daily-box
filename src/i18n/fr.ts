...
const fr: Translations = {
  ...
  "header.unseen_achievements": "{{count}} nouveaux succès à voir",
  "header.notifications_badge": "{{count}} notifications en attente",
  "header.unseen_achievements_dot": "Nouveau succès à voir",
  ...
  "gpEvent.soon_sub": "Samedi et dimanche, chaque défi vaut le double.",
  "gpEvent.ends_in": "Se termine dans",
  "gpEvent.starts_in": "Commence dans",
  "gpEvent.aria_active": "Week-end du Grand Prix de {{circuit}} : aujourd'hui les défis rapportent {{multiplier}} fois les points.",
  "gpEvent.aria_soon": "Week-end du Grand Prix de {{circuit}} : samedi et dimanche, les défis rapporteront {{multiplier}} fois les points.",
};
