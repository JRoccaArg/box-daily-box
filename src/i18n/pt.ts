...
const pt: Translations = {
  ...
  "consent.message": "Usamos análises para entender como as pessoas jogam e melhorar o site. Você pode aceitar ou recusar.",
  "consent.accept": "Aceitar",
  "consent.reject": "Recusar",
  "consent.manage": "Gerenciar cookies",
  ...
  "profile.delete_account": "Excluir minha conta",
  "profile.delete_warning": "Seu histórico de partidas, conquistas, medalhas, amigos e duelos serão excluídos para sempre. Esta ação não pode ser desfeita.",
  "profile.delete_confirm": "Sim, excluir tudo",
  ...
  "badge.ach_legend_10": "Lenda Viva",
  "badge.ach_legend_50": "Mestre da Lenda",
  "badge.ach_wins_100": "Centurião",
  "badge.ach_wins_500": "500 Voltas",
  "badge.ach_specialist_50": "Especialista",
  "badge.ach_perfect_day": "Grande Prêmio Perfeito",
  "badge.ach_complete": "Piloto Completo",
  "badge.tooltip_ach_legend_10": "10 vitórias na dificuldade Lenda.",
  "badge.tooltip_ach_legend_50": "50 vitórias na dificuldade Lenda.",
  "badge.tooltip_ach_wins_100": "100 vitórias acumuladas.",
  "badge.tooltip_ach_wins_500": "500 vitórias acumuladas — nível de elite.",
  "badge.tooltip_ach_specialist_50": "Venceu o mesmo jogo 50 vezes.",
  "badge.tooltip_ach_perfect_day": "Venceu todos os 8 jogos em um único dia.",
  "badge.tooltip_ach_complete": "Venceu cada um dos 8 jogos disponíveis ao menos uma vez.",
  "stats.tab_achievements": "Conquistas",
  "achievement.loading": "Carregando conquistas...",
  "achievement.load_error": "Não foi possível carregar as conquistas.",
  "achievement.title": "Minhas conquistas",
  "achievement.unlocked_count": "{{count}} de {{total}} desbloqueadas",
  "achievement.featured_title": "Badges do ranking",
  "achievement.automatic_badge": "Automático",
  "achievement.automatic_hint": "O sistema mostra primeiro o pódio e depois suas conquistas mais difíceis.",
  "achievement.manual_hint": "Toque em uma conquista desbloqueada para adicioná-la ou removê-la. Você também pode remover medalhas selecionadas.",
  "achievement.remove_featured": "Remover {{name}} do ranking",
  "achievement.none_selected": "Nenhum badge será exibido ao lado do seu nome.",
  "achievement.max_reached": "As 3 vagas disponíveis já estão ocupadas.",
  "achievement.use_automatic": "Usar seleção automática",
  "achievement.unlocked": "Desbloqueada",
  "achievement.in_progress": "Em progresso",
  "achievement.unlocked_toast": "Conquista desbloqueada: {{name}}!",
  "badge.admin": "Admin",
  ...
  "teamradio.said_by": "Dito no rádio de: {{driver}}",
