...
const pt: Translations = {
  ...
  "footer.photo_credit": "Fotos dos pilotos: Wikimedia Commons (CC BY-SA / domínio público).",
  "header.progress": "{{played}} de {{total}} jogos jogados hoje",
  ...
  "ranking.played_no_win": "Jogou, sem vitórias",
  "ranking.pts": "pts",
