...
const it: Translations = {
  ...
  "header.stats": "Stats",
  "header.pending_requests": "{{count}} richieste di amicizia in sospeso",
  ...
  "ranking.already_friends": "Già amici",
  "ranking.request_pending": "Richiesta inviata, in attesa di risposta",
  ...
  "game.career-path.tagline": "Guarda la sequenza di scuderie di un pilota e indovina chi è.",
  "careerpath.eyebrow": "Percorso di carriera",
  "careerpath.hint": "Queste sono le scuderie per cui ha corso il pilota, in ordine. Indovina chi è.",
  "careerpath.attempt": "Tentativo {{current}} di {{max}}",
  "careerpath.placeholder": "Scrivi un pilota…",
  "careerpath.found": "Lo hai trovato:",
  "careerpath.answer_was": "Il pilota era:",
  ...
  "seo.contact.title": "Contatti | Box Daily Box",
  "seo.contact.description": "Hai un problema tecnico o un'idea per Box Daily Box? Scrivici.",
  "seo.game.career-path.title": "Career Path — Indovina il pilota dalla sua carriera | Box Daily Box",
  "seo.game.career-path.description":
    "Guarda la catena di scuderie con cui ha corso un pilota di F1 e indovina chi è. Puzzle giornaliero gratis.",
  "contact.title": "Contatti",
  "contact.intro":
    "Hai trovato un problema, hai un'idea per un nuovo gioco o qualsiasi altra domanda? Scrivici:",
  ...
  "badge.monthly_silver": "Argento",
  "badge.monthly_bronze": "Bronzo",
  "badge.admin": "Admin",
  "badge.superadmin": "Superadmin",
  "badge.more": "+{{count}}",
  "badge.gallery_title": "I Miei Badge",
  "badge.gallery_empty":
    "Non hai ancora guadagnato alcun badge. Termina tra i 3 migliori della classifica mensile!",
  "badge.gallery_hint": "Tocca un badge per metterlo in evidenza nella classifica (fino a 3).",
  "badge.featured_count": "{{count}}/3 in evidenza",
  "badge.won_months": "Guadagnato in: {{months}}",
  "badge.show_grouped": "Raggruppato (×{{count}})",
  "badge.show_individual": "Individuale",
  "badge.max_reached": "Hai già scelto il massimo di 3 badge in evidenza",
  "badge.save": "Salva selezione",
  ...
  "friends.add_by_code": "Aggiungi",
  "friends.code_placeholder": "CODICE",
  "friends.invalid_code": "Il codice deve avere 6 caratteri",
  "friends.your_code": "Il tuo codice: {{code}}",
  "friends.copy_code": "Copia",
  "friends.code_copied": "Codice copiato",
  "friends.pending_requests": "Richieste in sospeso ({{count}})",
  "friends.sent_requests": "Inviate, in attesa di risposta",
  "friends.accept": "Accetta",
  "friends.reject": "Rifiuta",
  "friends.no_friends": "Non hai ancora aggiunto amici. Condividi il tuo codice in modo che possano aggiungerti.",
  "friends.anon_warning": "Sei anonimo: se cancelli il browser o cambi dispositivo, perdi questo elenco. Accedi con Google per non perderlo.",
  "friends.request_sent": "Richiesta inviata",
  "friends.request_accepted": "Ora siete amici!",
  "friends.remove": "Rimuovi amico",
  "friends.remove_confirm": "Rimuovere questo amico?",
  "friends.list_empty_short": "Nessun amico ancora",

  "duel.invitation_label": "Sfida di duello",
  "duel.invitation_from": "{{name}} ti ha sfidato a {{game}}",
  "duel.someone": "Qualcuno",
  "duel.expires_in": "Scade tra {{seconds}}s",
  "duel.more_pending": "+{{count}} altri",
  "duel.accept_or_reject_accept": "Accetta",
  "duel.accept_or_reject_reject": "Rifiuta",
  "duel.challenge_button": "Sfida",
  "duel.pick_game": "Scegli gioco, difficoltà e tempo",
  "duel.game_label": "Gioco",
  "duel.challenging_friend": "Stai per sfidare {{name}}",
  "duel.open_link": "Genera link aperto (per chiunque)",
  "duel.error_generic": "Impossibile creare il duello. Riprova.",
  "duel.loading": "Caricamento duello…",
  "duel.not_found": "Questo duello non esiste o non è più disponibile.",
  "duel.waiting_opponent": "In attesa che accetti…",
  "duel.waiting_finish": "In attesa che il tuo avversario finisca…",
  "duel.cancel": "Annulla",
  "duel.cancelled_by_you": "Hai annullato il duello.",
  "duel.expired": "Il duello è scaduto.",
  "duel.cancelled": "Il duello è stato annullato.",
  "duel.condition": "{{game}} · {{difficulty}} · {{time}}s",
  "duel.you_won": "Hai vinto!",
  "duel.you_lost": "Hai perso",
  "duel.tied": "Pareggio",
  "duel.rematch": "Rivincita",
  "duel.rematch_sent": "Invito di rivincita inviato",
  "duel.your_score": "Tu: {{points}} pts in {{seconds}}s",
  "duel.opponent_score": "Avversario: {{points}} pts in {{seconds}}s",
  "duel.go_home": "Torna alla home",
  "duel.share_link": "Condividi link",
  "duel.link_copied": "Link copiato negli appunti",

  // ─── Modo Carrera ───────────────────────────────────────────────
  "career.abandon.confirm_body": "Questo cancellerà i progressi di questa partita. Non si può annullare.",
  "career.abandon.confirm_no": "Annulla",
  "career.abandon.confirm_title": "Abbandonare questa carriera?",
  "career.abandon.confirm_yes": "Sì, abbandona",
  "career.abandon.link": "Abbandona carriera",
  "career.event.continue": "Continua",
  "career.event.progress": "Evento {{current}} di {{total}}",
  "career.history.empty": "Non hai ancora corso nessuna stagione",
  "career.history.eyebrow": "Modalità Carriera",
  "career.history.points_teammate": "Compagno: {{points}} pt",
  "career.history.points_you": "Tu: {{points}} pt",
  "career.history.title": "La tua carriera",
  "career.history.wins_podiums": "{{wins}} vittorie, {{podiums}} podi",
  "career.no_seat.body": "Non hai un team questa stagione. Simula l'anno per vedere se arrivano offerte.",
  "career.no_seat.eyebrow": "Senza team",
  "career.no_seat.simulate": "Simula anno",
  "career.no_seat.title": "In cerca di un team",
  "career.offers.accept": "Accetta",
  "career.offers.car_rank": "Auto Nº{{rank}} dell'anno",
  "career.offers.decline_all": "Rifiuta tutte",
  "career.offers.decline_confirm_body": "Resterai senza team quest'anno. Potresti ricevere nuove offerte l'anno prossimo.",
  "career.offers.decline_confirm_no": "Annulla",
  "career.offers.decline_confirm_title": "Rifiutare tutte le offerte?",
  "career.offers.decline_confirm_yes": "Sì, rifiuta",
  "career.offers.eyebrow": "Mercato piloti",
  "career.offers.intro": "Il tuo contratto è terminato. Questi team vogliono ingaggiarti:",
  "career.offers.role_first": "Prima guida",
  "career.offers.role_second": "Seconda guida",
  "career.offers.rookie_intro": "Sei nuovo in Formula 1. Questi team ti offrono un sedile:",
  "career.offers.rookie_title": "Le tue prime offerte",
  "career.offers.title": "Offerte dei team",
  "career.offers.years": "Contratto di {{years}} anno/i",
  "career.ready.contract_years": "Contratto: {{years}} anno/i rimanenti",
  "career.ready.eyebrow": "Modalità Carriera",
  "career.ready.retire_button": "Ritirati",
  "career.ready.retire_confirm_body": "La tua carriera finirà qui. Questa azione non si può annullare.",
  "career.ready.retire_confirm_no": "Continua a correre",
  "career.ready.retire_confirm_title": "Ritirarsi?",
  "career.ready.retire_confirm_yes": "Sì, ritirati",
  "career.ready.season_of_max": "Stagione {{season}} di {{max}}",
  "career.ready.simulate_button": "Simula {{step}} stagione/i",
  "career.retired.epilogue_champion": "Il tuo nome entra nei libri di storia: campione del mondo.",
  "career.retired.epilogue_scorer": "Non hai mai vinto una gara, ma hai fatto punti e lasciato il segno.",
  "career.retired.epilogue_struggler": "Non l'auto o la fortuna che sognavi, ma hai corso nella massima categoria dell'automobilismo.",
  "career.retired.epilogue_winner": "Hai vinto gare e guadagnato il rispetto del paddock, anche se il titolo ti è sfuggito.",
  "career.retired.eyebrow": "Fine carriera",
  "career.retired.new_career": "Nuova carriera",
  "career.retired.reason_max_seasons": "Hai completato le 24 stagioni",
  "career.retired.reason_no_offers": "Nessun team ti ha offerto un sedile",
  "career.retired.reason_voluntary": "Hai deciso di appendere il casco al chiodo",
  "career.retired.summary_championships": "Campionati",
  "career.retired.summary_dnfs": "Ritiri",
  "career.retired.summary_podiums": "Podi",
  "career.retired.summary_poles": "Pole",
  "career.retired.summary_seasons": "Stagioni",
  "career.retired.summary_teammate_record": "Hai battuto il tuo compagno {{won}} volte, perso {{lost}}",
  "career.retired.summary_wins": "Vittorie",
  "career.season.accidents": "Incidenti",
  "career.season.constructors_champion": "Il tuo team è campione costruttori!",
  "career.season.continue": "Continua",
  "career.season.drivers_champion": "Campione piloti!",
  "career.season.eyebrow": "Riepilogo stagione",
  "career.season.fastest_laps": "Giri veloci",
  "career.season.mechanical_dnfs": "Ritiri meccanici",
  "career.season.no_seat": "Non hai corso questa stagione",
  "career.season.overtakes": "Sorpassi",
  "career.season.performance_above": "Hai reso oltre il potenziale della tua auto",
  "career.season.performance_below": "Hai reso meno del potenziale della tua auto",
  "career.season.performance_even": "Hai reso in linea con la tua auto",
  "career.season.podiums": "Podi",
  "career.season.points": "Punti",
  "career.season.poles": "Pole",
  "career.season.position": "Posizione",
  "career.season.teammate_comparison": "Tu: {{points}} pt — {{teammate}}: {{teammatePoints}} pt",
  "career.season.title": "Stagione {{year}}",
  "career.season.wins": "Vittorie",
  "career.setup.eyebrow": "Modalità Carriera",
  "career.setup.first_name": "Nome",
  "career.setup.intro": "Crea un pilota e vivi la sua carriera: fino a 24 stagioni di decisioni, fortuna e risultati. Non influisce sulla tua classifica né sulle statistiche della sfida giornaliera.",
  "career.setup.last_name": "Cognome",
  "career.setup.mode_1": "1 anno alla volta",
  "career.setup.mode_1_hint": "Più controllo, partite più lunghe",
  "career.setup.mode_2": "2 anni alla volta",
  "career.setup.mode_2_hint": "Un equilibrio tra controllo e ritmo",
  "career.setup.mode_3": "3 anni alla volta",
  "career.setup.mode_3_hint": "Partite più veloci",
  "career.setup.mode_hint": "Di quanti anni avanzi alla volta",
  "career.setup.mode_label": "Modalità di gioco",
  "career.setup.name_required": "Inserisci nome e cognome",
  "career.setup.nationality": "Nazionalità",
  "career.setup.nationality_placeholder": "Scegli la tua nazionalità",
  "career.setup.nationality_required": "Scegli una nazionalità",
  "career.setup.start_button": "Crea pilota",
  "career.setup.title": "Crea il tuo pilota",

  // ─── Modo Carrera: card destacada + SEO ─────────────────────────
  "home.career_mode.eyebrow": "Simulatore di carriera",
  "home.career_mode.title": "Modalità Carriera",
  "home.career_mode.subtitle": "Crea il tuo pilota e vivi fino a 24 stagioni di decisioni e risultati.",
  "home.career_mode.badge": "PROVA ORA",
  "seo.career.title": "Modalità Carriera — Simula la carriera del tuo pilota di F1 | Box Daily Box",
  "seo.career.description": "Crea un pilota di Formula 1 e vivi la sua carriera: fino a 24 stagioni di decisioni, eventi e risultati. Gratis, senza registrazione.",
};
