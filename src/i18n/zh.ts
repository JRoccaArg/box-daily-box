...
const zh: Translations = {
  ...
  "profile.delete_warning": "您的对局记录、成就、徽章、好友和对决将被永久删除。此操作无法撤销。",
  "profile.delete_confirm": "是的，全部删除",
  "profile.deleting": "正在删除...",
  "profile.delete_error": "无法删除账户，请重试。",
  ...
  "achievement.unlocked_toast": "成就解锁：{{name}}！",
  "badge.admin": "管理员",
